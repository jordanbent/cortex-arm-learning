...
const gdb_expansion_1 = require("../src/backend/gdb_expansion");
suite("GDB Value Expansion", () => {
    ...
    test("Simple node", () => {
        ...
        let variables = gdb_expansion_1.expandValue(variableCreate, `{a = false, b = 5, c = 0x0, d = "foobar"}`);
    ...
    test("Complex node", () => {
        ...
        let variables = gdb_expansion_1.expandValue(variableCreate, node);
