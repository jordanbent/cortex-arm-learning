...
suite('TcpPortScanner Tests', () => {
    test('TcpPortScanner finder/waitfor(open/close) tests', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const port = ports[1];
        timeit();
        yield tcpportscanner_1.TcpPortScanner.waitForPortOpen(port, hostNameOrIp, false, 100, 100).then(() => {
            ...
            tcpportscanner_1.TcpPortScanner.waitForPortOpen(port, hostNameOrIp, true, 50, 1000).then(() => __awaiter(this, void 0, void 0, function* () {
                if (doLog) {
            ...
            yield tcpportscanner_1.TcpPortScanner.waitForPortOpenOSUtl(port, 50, 1000, false, doLog).then(() => {
                if (doLog) {
